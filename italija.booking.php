        ...
        <div class="container-image-italy">
            <div class="container-i">
             ...
             <div class="container-i2">
                ...
                <p class="paragraph12">Prostrane, dobro dizajnirane sobe sa ugradbenim ormarima; moderna kupatila. Blizina željezničke stanice, restorana, turističkih atrakcija. Krovna terasa, besplatan mini-bar. </p>
            ...
            <div class="container-i3">
                ...
                <p class="paragraph12">Sa idealnom lokacijom u blizini glavnih atrakcija i metro stanica, ovaj butik hotel gostima nudi miran odmor usred užurbanih ulica. Prepustite se izvanrednom doručku, otmjenom restoranu i baru na krovu, luksuznim sobama s besplatnim mini barovima i impresivnim apartmanima za medeni mjesec. </p>
                <a href="" class="button4">Detalji</a>
                <a href="" class="button5">Rezerviši</a>
                 <p class="paragraph13"> </p>
                <img src="italy.hotel3.jpg" alt="hotel2">
            </div>
        </div>
