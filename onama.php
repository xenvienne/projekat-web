...
<body>
    <header>
        ...
        <h1>O NAMA</h1>
             ...
             <p class="paragraph1">Važnost planiranja bezbrižnog putovanja i mi smo tu da se brinemo o svakom detalju. Vjerujemo da je putovanje jedno od najvećih životnih užitaka i trudimo se da putnicima učinimo putovanje što lakšim i ugodnijim.</p>
             
                
    
        
        
            <p class="paragraph2">Naš tim iskusnih stručnjaka za putovanja je posvećen pronalaženju savršenog putnog aranžmana, bez obzira da li tražite romantični odmor, porodično putovanje ili poslovni put. Imamo pristup ekskluzivnim i posebnim ponudama koje nećete pronaći nigdje drugdje.</p>
        
        </div>
        
         <div class="naslov">
            <h2>ZAŠTO IZABRATI NAS?</h2><br><br>
            <div class="bxs">
                <img src="sea.png" alt="Image 20">
